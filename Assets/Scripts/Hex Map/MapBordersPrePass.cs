...
public class MapBordersPrePass : MonoBehaviour
{
	...
	//	var glowShader = Shader.Find("Hidden/TerrainBordersReplace");
	//	camera.targetTexture = PrePass;
	//	camera.SetReplacementShader(glowShader, "TerrainBorders");
